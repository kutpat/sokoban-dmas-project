...
public class StepTimeManager extends AbstractTimeManager {
  ...
  @Override
  @Pure
  public synchronized float getCurrentTime(@DefaultValue("framework.time.Time#GETCURRENTTIME_0") final TimeUnit unit) {
  ...
  @Override
  @Pure
  public synchronized float getLastStepDuration(@DefaultValue("framework.time.Time#GETLASTSTEPDURATION_0") final TimeUnit unit) {
    TimeUnit _elvis = null;
    if (unit != null) {
      _elvis = unit;
    } else {
