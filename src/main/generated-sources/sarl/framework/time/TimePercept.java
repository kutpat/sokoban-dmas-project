...
public class TimePercept extends AbstractTime implements Serializable, Cloneable {
  ...
  @DefaultValueSource
  @Pure
  public float getCurrentTime(@DefaultValue("framework.time.Time#GETCURRENTTIME_0") final TimeUnit unit) {
    return AbstractTime.secondsToUnits(this.currentTime, unit);
  }

  @DefaultValueSource
  @Pure
  public float getLastStepDuration(@DefaultValue("framework.time.Time#GETLASTSTEPDURATION_0") final TimeUnit unit) {
